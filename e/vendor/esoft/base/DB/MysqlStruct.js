function MysqlStruct(){
    ...
    this.where = function(delimiter){
        ...
        return this.struct.where.length > 0 ? " where " + this.struct.where.join(delimiter) : "";
    }

    this.having = function(delimiter){
        delimiter = delimiter || ' and ';
        return this.struct.having.length > 0 ? " having " + this.struct.having.join(delimiter) : "";
    }
    ...
    this.groupBy = function(){
        return this.struct.groupBy.length > 0 ? " group by  " + this.struct.groupBy.join(" and ") : "";
    }
    ...
    this.orderBy = function(){
        return this.struct.orderBy.length > 0 ? " order by " +  this.struct.orderBy.join(', ') : '';
    }
     ...
     */
    this.limit = function(){
        return this.struct.limit.length > 0 ? " limit " +  this.struct.limit.join(', ') : '';
    }
